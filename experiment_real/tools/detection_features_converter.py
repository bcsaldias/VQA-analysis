...
infile = 'experiment_real/data/trainval_36/trainval_resnet101_faster_rcnn_genome_36.tsv'
train_data_file = 'experiment_real/data/train36.hdf5'
val_data_file = 'experiment_real/data/val36.hdf5'
train_indices_file = 'experiment_real/data/train36_imgid2idx.pkl'
val_indices_file = 'experiment_real/data/val36_imgid2idx.pkl'
train_ids_file = 'experiment_real/data/train_ids.pkl'
val_ids_file = 'experiment_real/data/val_ids.pkl'
