...
if __name__ == '__main__':
    train_answer_file = 'data/abstract_v002_train2015_annotations.json'
    train_answers = json.load(open(train_answer_file))['annotations']

    val_answer_file = 'data/abstract_v002_val2015_annotations.json'
    val_answers = json.load(open(val_answer_file))['annotations']

    train_question_file = 'data/OpenEnded_abstract_v002_train2015_questions.json'
    train_questions = json.load(open(train_question_file))['questions']

    val_question_file = 'data/OpenEnded_abstract_v002_val2015_questions.json'
